define(['dart_sdk', 'packages/angular_forms/src/directives/control_value_accessor.template', 'packages/angular/angular.template'], function(dart_sdk, control_value_accessor, angular) {
  ...
  dart.fn(src__directives__number_value_accessor$46template.initReflector, VoidTovoid());
  dart.trackLibraries("packages/angular_forms/src/directives/number_value_accessor.template.ddc", {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["number_value_accessor.template.dart"],"names":[],"mappings":";;;;;;;;;;;MAaI,0DAAQ;YAAG;;;;;AAEb,kBAAI,0DAAQ,GAAE;AACZ;;AAEF,iEAAW;AAEX,IAAM,gEAAa;AACnB,IAAM,gCAAa;EACrB","file":"number_value_accessor.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=number_value_accessor.template.ddc.js.map
