define(['dart_sdk', 'packages/angular_forms/src/directives/validators.template', 'packages/angular_forms/src/directives/abstract_form.template', 'packages/angular_forms/src/directives/control_container.template', 'packages/angular/angular.template'], function(dart_sdk, validators, abstract_form, control_container, angular) {
  ...
  dart.fn(src__directives__ng_form$46template.initReflector, VoidTovoid());
  dart.trackLibraries("packages/angular_forms/src/directives/ng_form.template.ddc", {
    "package:angular_forms/src/directives/ng_form.template.dart": src__directives__ng_form$46template
  }, '{"version":3,"sourceRoot":"","sources":["ng_form.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;MA0BI,4CAAQ;YAAG;;;;;AAEb,kBAAI,4CAAQ,GAAE;AACZ;;AAEF,mDAAW;AAEX,IAAM,mCAAa;AACnB,IAAM,wCAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,2DAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,0DAAa;AACnB,IAAM,gCAAa;AACnB,IAAM,gDAAa;EACrB","file":"ng_form.template.ddc.js"}');
  // Exports:
  return {
...
//# sourceMappingURL=ng_form.template.ddc.js.map
