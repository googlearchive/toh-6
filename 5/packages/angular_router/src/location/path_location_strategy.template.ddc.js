define(['dart_sdk', 'packages/angular/src/di/reflector', 'packages/angular_router/src/location/path_location_strategy', 'packages/angular_router/src/location/platform_location', 'packages/angular/src/core/di/opaque_token', 'packages/angular/src/core/di/decorators', 'packages/angular_router/src/location/location.template', 'packages/angular_router/src/location/location_strategy.template', 'packages/angular/angular.template', 'packages/angular_router/src/location/platform_location.template'], function(dart_sdk, reflector, path_location_strategy, platform_location, opaque_token, decorators, location, location_strategy, angular, platform_location$) {
  'use strict';
  ...
  dart.fn(src__location__path_location_strategy$46template.initReflector, VoidTovoid());
