...
class ViewDashboardComponent0 extends AppView<import2.DashboardComponent> {
  ...
  import7.HeroSearchService _HeroSearchService_4_5;
  ...
  ComponentRef<import2.DashboardComponent> build() {
    ...
    addShimC(_el_4);
    _HeroSearchService_4_5 = new import7.HeroSearchService(parentView.injectorGet(import15.Client, viewData.parentIndex));
    _HeroSearchComponent_4_6 = new import8.HeroSearchComponent(_HeroSearchService_4_5, parentView.injectorGet(import16.Router, viewData.parentIndex));
    _compView_4.create(_HeroSearchComponent_4_6, []);
    init(const [], null);
    return null;
  }
...
class _ViewDashboardComponent1 extends AppView<import2.DashboardComponent> {
  ...
  import17.RouterLinkNgCd _RouterLink_0_5;
  ...
  ComponentRef<import2.DashboardComponent> build() {
    ...
    addShimC(_el_0);
    _RouterLink_0_5 = new import17.RouterLinkNgCd(new import18.RouterLink(parentView.parentView.injectorGet(import16.Router, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import19.Location, parentView.viewData.parentIndex), null, _el_0));
...
class _ViewDashboardComponentHost0 extends AppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _DashboardComponent_0_5 = new import2.DashboardComponent(this.injectorGet(import21.HeroService, viewData.parentIndex));
